    ...
    stages {
        ...
        stage('Build') {
            steps {
                ...
                sh 'zip target/java-web-app-1.0.war.zip /var/lib/jenkins/workspace/java/target/java-web-app-1.0.war'
            }
        }
        ...
        stage('Archive Artifact to S3') {
            steps {
                ...
                sh """
                    ...
                    aws s3 cp target/java-web-app-1.0.war.zip s3://${S3_BUCKET}/
                """
            }
        }
    }
